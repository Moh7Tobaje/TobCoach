      ...
      <div className="min-h-screen">
        ...
        <nav className="fixed top-0 w-full z-50 bg-background/80 backdrop-blur-md border-b border-border">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold font-[var(--font-heading)]">Top Coach</span>
            </div>
            <div className="hidden md:flex space-x-6">
              <Button variant="ghost" onClick={() => setActiveTab("workout")}>
                Workout
              </Button>
              <Button variant="ghost" onClick={() => setActiveTab("nutrition")}>
                Nutrition
              </Button>
            ...
            <Button className="gradient-red-silver glow-red">Start Training Free</Button>
          </div>
        </nav>
        ...
        <section className="pt-24 pb-16 px-4 relative overflow-hidden">
          ...
          <div className="container mx-auto text-center relative z-10">
            ...
            >
              <Badge className="mb-6 gradient-red-silver text-white border-0">
                <Zap className="w-4 h-4 mr-2" />
                AI-Powered Fitness Revolution
              </Badge>
              <h1 className="text-4xl md:text-6xl font-bold font-[var(--font-heading)] mb-6 bg-gradient-to-r from-white to-gray-200 bg-clip-text text-transparent drop-shadow-lg">
                Transform Your Body with
                <span className="block text-primary drop-shadow-lg">AI Coaching</span>
              </h1>
              <p className="text-xl text-gray-200 mb-8 max-w-2xl mx-auto leading-relaxed drop-shadow-md">
                Experience personalized workouts, smart nutrition planning, and 24/7 AI coaching that adapts to your
                goals and lifestyle.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                <Button size="lg" className="gradient-red-silver glow-red text-lg px-8 py-6">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="text-lg px-8 py-6 border-white/30 hover:glow-silver bg-white/10 backdrop-blur-sm text-white hover:bg-white/20"
                >
                  Watch Demo
                </Button>
              </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-8 items-center">
                    <div className="space-y-4">
                      ...
                      <div className="flex space-x-2">
                        <Button size="sm" variant="outline" onClick={() => handleQuickAction("Generate Workout")}>
                          Generate Workout
                        </Button>
                        <Button size="sm" variant="outline" onClick={() => handleQuickAction("Adjust Intensity")}>
                          Adjust Intensity
                        </Button>
                      </div>
                    </div>
                    <div className="space-y-4">
                      <div className="bg-card p-4 rounded-lg border border-border">
                        ...
                        <p className="text-sm text-muted-foreground">3 of 4 exercises completed</p>
                      </div>
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 w-full bg-card/80 backdrop-blur-md border-t border-border md:hidden">
          <div className="flex justify-around py-2">
            <Button variant="ghost" size="sm" onClick={() => setActiveTab("home")} className="flex-col space-y-1">
              <Bot className="w-5 h-5" />
              <span className="text-xs">Home</span>
            </Button>
            <Button variant="ghost" size="sm" onClick={() => setActiveTab("workout")} className="flex-col space-y-1">
              <Dumbbell className="w-5 h-5" />
              <span className="text-xs">Workout</span>
            </Button>
            <Button variant="ghost" size="sm" onClick={() => setActiveTab("nutrition")} className="flex-col space-y-1">
              <Apple className="w-5 h-5" />
              <span className="text-xs">Nutrition</span>
            </Button>
            <Button variant="ghost" size="sm" onClick={() => setActiveTab("progress")} className="flex-col space-y-1">
              <BarChart3 className="w-5 h-5" />
              <span className="text-xs">Progress</span>
            </Button>
            <Button variant="ghost" size="sm" onClick={() => setActiveTab("community")} className="flex-col space-y-1">
              <Users className="w-5 h-5" />
              <span className="text-xs">Community</span>
            </Button>
            <Button variant="ghost" size="sm" onClick={() => setActiveTab("chat")} className="flex-col space-y-1">
        ...
        <Button
          className="fixed bottom-20 right-4 md:bottom-6 w-14 h-14 rounded-full gradient-red-silver glow-red shadow-lg"
      ...
      <div className="min-h-screen p-4 pt-20">
        <div className="container mx-auto max-w-4xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h1 className="text-3xl font-bold font-[var(--font-heading)]">Today's Workout</h1>
              <p className="text-muted-foreground">Upper Body Strength • 45 min</p>
            </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      <div
                        className={`w-12 h-12 rounded-full flex items-center justify-center ${exercise.completed ? "bg-primary" : "bg-card border-2 border-border"}`}
                      >
                        {exercise.completed ? (
